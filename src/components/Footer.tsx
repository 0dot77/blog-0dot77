  ...
  return (
    <footer className="border-t border-border">
      <div className="max-w-360 mx-auto px-6 md:px-12 py-8 flex flex-col md:flex-row items-center justify-between gap-4">
        <p className="font-(family-name:--font-mono) text-xs text-text-secondary">
        ...
        <div className="flex items-center gap-6">
          <Link
            ...
            className="font-(family-name:--font-mono) text-xs text-text-secondary hover:text-accent transition-colors"
          >
            GitHub
          </Link>
          <Link
