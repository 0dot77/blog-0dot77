        ...
        <div className="flex flex-col">
              ...
              <article className="py-8 border-b border-border flex gap-6 transition-colors">
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-3 mb-2">
                    <time className="font-[family-name:var(--font-mono)] text-xs text-text-secondary shrink-0">
                      {post.date}
                    </time>
          ...
          {posts.length === 0 && (
            <div className="text-center py-20">
              <p className="font-[family-name:var(--font-mono)] text-lg text-text-secondary mb-2">
                아직 글이 없습니다
              </p>
              <p className="font-[family-name:var(--font-mono)] text-sm text-text-secondary">
                곧 첫 번째 글이 올라올 예정입니다.
